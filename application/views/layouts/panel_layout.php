        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav pull-right">
                    <li>
                        <a href="<?php echo site_url('panel/dashboard/upgrade_panel') ?>">Upgrade panel</a>
                    </li>
                    <li>
                        <a href="<?php echo site_url('panel/dashboard/repository_content') ?>">Your Repository </a>
                    </li>
                    <li>
                        <a href="<?php echo site_url('panel/dashboard/repository_list') ?>">Friends Repository 
                        <span class="badge" style="background-color:lightblue;color:darkblue"> <?php echo $friend_repository ?> </span>
                        </a>
                    </li>
                    <li>
